...
export function Sidebar({ onLogout, userEmail }: SidebarProps) {
  ...
  return (
    <aside className="fixed top-0 left-0 w-72 h-full z-50 bg-white border-r border-gray-200 flex flex-col">
      {/* Logo */}
      <div className="h-24 flex items-center gap-3 px-8 border-b border-gray-100">
